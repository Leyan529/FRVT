...
config.network = "elannet"         # 4549050368
# config.network = "RepVGG_B3g4"   # 5004787712
# config.network = "RepVGG_B3"   # 5004787712
# config.network = "r100"          # 4233756672
# config.network = "resnet_269"    # 4174577664
