...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str,       
        ...
        default="work_dirs/ms1m-retinaface-t1_elannet_local/model_epoch_0000_step_002000.pt",
    ...
    parser.add_argument('--network', type=str, default="elannet", help='backbone network')
