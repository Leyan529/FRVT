...
int AnchorGenerator::FilterAnchor(ncnn::Mat& score, ncnn::Mat& reg, std::vector<Anchor>& result) {
    // assert(score.c == anchor_num*2);
    // assert(reg.c == anchor_num*4);

    // std::cout << "anchor_num: " << anchor_num << std::endl;
    // assert(score.w*2 == anchor_num);
    // assert(reg.w*2 == anchor_num*4);

    // transpose(score, score);
    // transpose(reg, reg);
    // assert(score.h*2 == anchor_num);
    // assert(reg.h*2 == anchor_num*4);
...
//            	std::cout<< j << i << id<<cls.channel(anchor_num + a)[id]<<",";
            	if (score.channel(anchor_num + a)[id] >= cls_threshold) {
                    // printf("score %f\n", score.channel(anchor_num + a)[id]);
                    ...
                    // printf("%f %f\n", i * anchor_stride + preset_anchors[a][1], i * anchor_stride + preset_anchors[a][3]);
                    // printf("%f %f\n", i * anchor_stride + preset_anchors[a][1], 0);
                    // printf("%f %f\n", i * anchor_stride , preset_anchors[a][1]);
                    // printf("%f %f %f\n", i * anchor_stride + preset_anchors[a][1] , i * anchor_stride, preset_anchors[a][1]);
                    // printf("%f %f %f\n", i * anchor_stride + preset_anchors[a][3] , i * anchor_stride, preset_anchors[a][3]);
                    // printf("-----------------------------\n");
                    ...
                    // printf("bbox pred\n");
                    res.score = score.channel(anchor_num + a)[id];
    ...
    std::cout << "valid anchor: " << result.size() << std::endl;
	return 0;
}
