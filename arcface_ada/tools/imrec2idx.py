...
def parse_args():
    ...
    parser.add_argument('--record', help='path to .rec file.', default="./tools/tmp/IJBC.rec")
    parser.add_argument('--index', help='path to index file.', default="./tools/tmp/IJBC.idx")
