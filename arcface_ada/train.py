...
from losses import AdaFace, CombinedMarginLoss
...
def main(args):    
    ...
    margin_loss = AdaFace(m=0.4, h=0.333, s=64, t_alpha=0.01)
    ...
    for epoch in range(start_epoch, cfg.num_epoch):        
        ...
        for it_step, (img, local_labels) in enumerate(train_loader):    
            try:
                ...
                loss: torch.Tensor = module_partial_fc(local_embeddings, local_labels, opt)  # input embedding & batch label
